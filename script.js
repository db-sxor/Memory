document.addEventListener("DOMContentLoaded", () => {
  const messages = [
    ...
    { name: "명미경", text: "사랑하는 현채야 그리고 차형제!! 우리가 마음은 항상 함께라는것, 언제나 두사람을 위해 기도하고 응원하고 있다는것 잊지말고.. 서부에서처럼 두사람의 진실한 사랑을 나눠주세요~~모두가 알 수 있게♡♡♡" },
    { name: "박수정", text: "사도행전 16:9 더 필요한 곳에서 섬기는 차형제, 송자매 여호와께서 배나 더 큰 축복을 베풀어 주실 것을 확신합니다. 화이팅!❣️" },
    ...
    { name: "조성령", text: "진주형 송자매 두 분이 서부에서 보여준 사랑과 희생 덕분에 많이 배웠고 저도 그런 사람이 되고싶다고 생각했습니다. 고양 수어에서도 정말 꼭 필요한 도움과 사랑을 나타낼거라 믿어요. 저에게 좋은 친구가 되어주셔서 감사합니다!" },
